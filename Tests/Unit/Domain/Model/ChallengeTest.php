...
class ChallengeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	{
		$move = new \ChaptedTeam\Chapted\Domain\Model\Move();
		$movesObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array('attach'), array(), '', FALSE);
	...
	{
		$move = new \ChaptedTeam\Chapted\Domain\Model\Move();
		$movesObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array('detach'), array(), '', FALSE);
